...
<body scroll="no">
	<div class="right_main">
		<div id="J_rframe" class="rframe_b">
			...
			<form id="info_form" action="<?php echo U('Product/add');?>" method="post" >
				<div class="pad_lr_10">
					<div class="col_tab">
						<div class="J_panes">
									...
									<tbody>
										<tr>
											...
											<td>
												...
												<?php if(is_array($data["0"]["son"])): $i = 0; $__LIST__ = $data["0"]["son"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["id"]); ?>">--<?php echo ($v["name"]); ?>--</option><?php endforeach; endif; else: echo "" ;endif; ?>
												</select>
										...
										<tr>
											...
											<td>
												<div class="pro_isize">
													<p>
													<?php if(is_array($size)): $i = 0; $__LIST__ = $size;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><span><?php echo ($val["name"]); ?></span><input type="checkbox" value="<?php echo ($val["id"]); ?>" name="p_size[]">&nbsp;<?php endforeach; endif; else: echo "" ;endif; ?>
													</p>
												</div>
											</td>
										</tr>
